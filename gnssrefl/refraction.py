...
def correct_elevations(ele, lsp, year, doy):
    ...
    Replicates the refraction logic from gnssir_v2 (set_refraction_params +
    model dispatch) so that callers outside gnssir can correct elevations
    without importing gnssir_v2.
