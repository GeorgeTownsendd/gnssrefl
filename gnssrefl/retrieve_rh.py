...
from gnssrefl.utils import format_qc_summary
...
def retrieve_rh(station,year,doy,extension, lsp, arcs, screenstats, irefr,logid,logfilename,dbhz):
    ...
    if True: # so we don't have to reindent everything ...
        ...
        for f in freqs:
            ...
            n_filter_ediff = 0; n_filter_tooclose = 0; n_filter_amp = 0; n_filter_pk2noise = 0; n_filter_delT = 0
            ...
            qc_line = format_qc_summary(f, n_total, qc_filters, good_arcs)
            ...
            total_arcs = good_arcs + total_arcs
