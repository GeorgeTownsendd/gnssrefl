...
def read_json_file(station, extension,**kwargs):
    ...
    if len(extension) == 0:
        useextension = False
        instructions_ext = ''
        instructions = str(os.environ['REFL_CODE']) + '/input/' + station + '/default/' + station + '.json'
    else:
        useextension = True 
        instructions_ext = str(os.environ['REFL_CODE']) + '/input/' + station + '/' + extension + '/' + station + '.json'
        instructions = str(os.environ['REFL_CODE']) + '/input/' + station + '/default/' + station + '.json'
